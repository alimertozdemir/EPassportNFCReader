...
import com.alimert.library.camera.CameraManager;
import com.alimert.library.camera.ShutterButton;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback,
    ...
    void handleOcrContinuousDecode(OcrResult ocrResult) {
        ...
        if (result != null && !"".equals(result)) {
            ...
            if (ocrResult.getMeanConfidence() >= 80 && textResultTmpArr.length >= 2 && textResultTmpArr.length <= 3) {
                try {
                    MRZInfo mrzInfo = new MRZInfo(result);
                    if (mrzInfo.getDocumentNumber() != null && mrzInfo.getDateOfBirth() != null && mrzInfo.getDateOfExpiry() != null) {
                        ...
                        Log.d("MRZ_RESULT: ", "DOC NUMBER: " + mrzInfo.getDocumentNumber() + "\n"
                        + "BIRTH DATE: " + mrzInfo.getDateOfBirth() + "\n"
                        + "EXPIRY DATE: " + mrzInfo.getDateOfExpiry());
